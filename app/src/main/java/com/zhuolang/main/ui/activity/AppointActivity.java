...
public class AppointActivity extends Activity implements AdapterView.OnItemClickListener{
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            simpleAdapter = new SimpleAdapter(AppointActivity.this, dataList, R.layout.doctor_item,
                    new String[]{"imageView", "name", "amount", "introduction", "office"},
                    new int[]{R.id.imageView, R.id.textView_name, R.id.textView_amount, R.id.textView_introduction, R.id.textView_office});
